      ...
      <div className='w-full flex flex-col'>
        ...
        <div className='w-full '>
            {category?.slice(0,7).map(({parent,icon,children},i)=>(
                <div className='flex flex-col hover:text-green-600  justify-between py-3 px-4 rounded-lg cursor-pointer '>
                ...
                <div>
                 ...
                 <div>
                  {children.map((title)=>(
                    <div className='flex justify-center py-1.5 bg-white rounded-md'>
                      <Link href={'/'}>
